...
public class AddElixirPage extends Page
{
	private TopView topView;
	private TextField itemName, itemLevel, itemDescription, itemDuration,
			itemStamina, itemStrength, itemSpirit, itemIntellect, itemAgility;
	private ComboBox<ItemRarity> itemRarity;
	private GridPane gridPane;
	private Button btnAdd, btnCancel;

	public AddElixirPage(PageManager pageManager)
	{
		super(pageManager);
	}
	...
	protected void initializePage()
	{
		...
		btnAdd.setOnAction(e ->
		{
			Elixir elixir = new Elixir(
					...
					Double.parseDouble(itemDuration.getText()),
			...
			Database.getInstance().addElixir(elixir);
			resetToDefault();
		...
		gridPane.addRow(4, new Label("Attack Speed"), itemDuration);
